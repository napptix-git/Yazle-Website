...
// Hide gesture image on any carousel interaction
...
slider.addEventListener("mousedown", hideGesture);
slider.addEventListener("touchstart", hideGesture);

// Also hide when user clicks on a radio button
radioButtons.forEach(radio => {
    radio.addEventListener("change", hideGesture);
});
