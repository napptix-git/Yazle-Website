...
const rightOffset = 80; // Increase right limit (move further)
...
function animateFall(item) {
    ...
    item.style.transform = `rotate(${tiltAngle}deg) scale(0.95)`;
...
function showGameOverDiv() {
    ...
    textDiv.innerHTML = `You delivered <strong>${score}</strong> items and won $0 delivery fees on your first McDonald's order!`;
