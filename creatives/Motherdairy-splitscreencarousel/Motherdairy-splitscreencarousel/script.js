document.addEventListener("DOMContentLoaded", () => {
    ...
    function dragMove(e) {
        ...
        sliderLabels.forEach((label, index) => {
            const offset = (index - currentIndex) * 115 + (deltaX / slider.clientWidth) * 115;
            label.style.transform = `translateX(${offset}%)`;
        });
    }
    ...
    function dragEnd() {
        ...
        // Use a lower threshold for smoother/faster slide change
        const dragThreshold = slider.clientWidth * 0.08;
